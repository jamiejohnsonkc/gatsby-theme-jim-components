...
import GroupGrid from '../../../product/layouts/GroupGrid/GroupGrid'
import GroupHead from '../../product/layouts/componentMap/GroupHead/GroupHead'
import ProgressBarGroup from '../../product/layouts/componentMap/ProgressBarGroup/ProgressBarGroup'
import LabeledProgressBar from '../../system/molecules/staticElements/LabeledProgressBar/LabeledProgressBar'
import Groups from '../../product/layouts/componentMap/progressBarData'
...
const AccordionItem = ({
	...
	return (
		<Box
			className={`accordion-item ${isOpen ? 'accordion-item--opened' : ''}`}
		...
		>
			...
			<Box
				...
				sx={{
					...
					transition: 'all .2s ease-in-out .2s',
					willChange: 'color, boxShadow, p, marginBottom, backgroundColor',
				}}
			>
			...
			>
				<Box
					...
					sx={{
						...
						opacity: `${isOpen ? '1' : '0'}`,
						transform: `${isOpen ? 'translateY(0)' : 'translateY(-2em)'}`,
					...
					<GroupGrid groupGridColumns={group.groupGridColumns}>
						{group.skillSets.map((skillSet, id) => (
							<ProgressBarGroup
								...
								groupSubGridColumns={skillSet.groupSubGridColumns}
